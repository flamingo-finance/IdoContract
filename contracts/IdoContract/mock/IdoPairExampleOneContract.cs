...
{
    [DisplayName("IdoPairExampleOneContract")]
    [ManifestExtra("Author", "NEO")]
    [ManifestExtra("Email", "developer@neo.org")]
    [ManifestExtra("Description", "This is an initial dex offering pair contract.")]
    [ContractPermission("*")]
    public class IdoPairExampleOneContract : SmartContract
    {
        ...
        public static Neo.UInt160 GetOwner() => (UInt160) Storage.Get(Storage.CurrentContext, superAdminKey);
